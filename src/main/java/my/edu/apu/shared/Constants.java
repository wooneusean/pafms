...
public class Constants {
    ...
    public static final String AIRPLANE_STATE_UPDATER_EXCHANGE_NAME = "airplane-state-exchange";
    ...
    public static final String ALL_SENSORS_TOPIC = "sensor.*";
    public static final String CONTROLLER_TO_ACTUATOR_EXCHANGE_NAME = "controller-to-actuator";
    public static final String ENGINE_ACTUATOR_ROUTING_KEY = "actuator.engine";
    public static final String SPEED_CONSUMER_TOPIC = "sensor.speed";
}
